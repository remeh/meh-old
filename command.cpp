...
void Command::execute(QString text) {
    ...
    if (command == ":def") {
        ...
        this->window->getEditor()->lspManager.setExecutedAction(this->window, reqId, LSP_ACTION_DEFINITION, currentBuffer);
    }
    ...
    if (command == ":dec") {
        ...
        this->window->getEditor()->lspManager.setExecutedAction(this->window, reqId, LSP_ACTION_DECLARATION, currentBuffer);
    }
    ...
    if (command == ":sig") {
        ...
        this->window->getEditor()->lspManager.setExecutedAction(this->window, reqId, LSP_ACTION_SIGNATURE_HELP, currentBuffer);
    }
    ...
    if (command == ":i" || command == ":info") {
        ...
        this->window->getEditor()->lspManager.setExecutedAction(this->window, reqId, LSP_ACTION_HOVER, currentBuffer);
    }
    ...
    if (command == ":ref") {
        ...
        this->window->getEditor()->lspManager.setExecutedAction(this->window, reqId, LSP_ACTION_REFERENCES, currentBuffer);
    }
    ...
    if (command == ":com") {
        ...
        this->window->getEditor()->lspManager.setExecutedAction(this->window, reqId, LSP_ACTION_COMPLETION, currentBuffer);
    }
